	...
	public void doLogik(long delta) {
		...
		if (timer >= 1000) {
			...
			if ((this.timeleft() <= 0 || this.isHasWon()) && this.setHighscore) {
				...
				setHighscore = false; //damit keine doppelten Eintr�ge erzeugt werden

				// TODO Highscoreeintrag erzeugen Highscore >> F_user_id, F_level_id, shots,
				// hits, reaction_time
				System.out.println("Highscoreeintrag f�r " + currentLevel.getName() + ": " + currentUser.getFirst_name()
